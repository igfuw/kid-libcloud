        ...
        do
          ...
          do
            ...
            do
              ...
              mkdir ${OUTDIR}/${run_no} 
              echo ${OUTDIR}/${run_no}
              FILEOUT=${OUTDIR}/${run_no} python ../kid_1D.py --sstp_coal=$sstp_coal --sstp_cond=$sstp_cond --backend="CUDA" --sd_conc=$sd_conc --n_tot=$ntot --spinup_rain=$spinup 
            done
          done
        done
      done
